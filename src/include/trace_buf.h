 ...
 *
 *    $Id: trace_buf.h 4153 2011-01-11 16:28:48Z kevin $
 *
 *    Revision history:
 *     $Log$
...
typedef struct {
        qint32     pinno;                 /* Pin number */
        qint32     nsamp;                 /* Number of samples in packet */
...
/*
        ...
        s4      SUN IEEE qint32eger
        s2      SUN IEEE short qint32eger
        f4      VAX/qint32el IEEE single precision real
        f8      VAX/qint32el IEEE double precision real
        i4      VAX/qint32el IEEE qint32eger
        i2      VAX/qint32el IEEE short qint32eger
